    ...
    <div className="bg-background min-h-screen">
      ...
      <section className="px-6 md:px-24 pt-16 md:pt-24 pb-20 border-b border-foreground">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_1fr] gap-12 lg:gap-24 items-start">
          <div>
            <h1 className="font-display font-black text-[clamp(64px,8vw,120px)] leading-[0.88] tracking-[-0.03em] text-foreground m-0 mb-8">
              Oversight<span className="text-primary">.</span>
            </h1>
            <div className="font-mono text-[13px] text-muted-foreground uppercase tracking-widest mb-4">
              The Missing Layer for Enterprise AI
            </div>
            <p className="font-text text-[22px] leading-lede text-foreground/80 max-w-[34ch]">
          ...
          {/* Metrics Grid */}
          <div className="grid grid-cols-2 gap-px bg-foreground border border-foreground mt-8 lg:mt-0">
            {[
              ...
              <div key={i} className="bg-background p-8 flex flex-col justify-center min-h-[160px]">
                <div className="font-display font-black text-[clamp(32px,4vw,48px)] tracking-[-0.02em] text-foreground leading-none mb-2">
                  {stat.value}
                </div>
      ...
      <section className="px-6 md:px-24 py-24 border-b border-foreground">
        <div className="max-w-[42ch] mb-20">
          <h2 className="font-display font-black text-[clamp(40px,5vw,64px)] leading-tight tracking-[-0.02em] text-foreground mb-6">
            Safely integrate AI into your enterprise.
          </h2>
          <p className="font-text text-[18px] leading-relaxed text-muted-foreground">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-px md:bg-foreground md:border md:border-foreground">
          {[
            {
              time: 'Phase 01',
            ...
            <div key={i} className="bg-background md:p-8 flex flex-col">
              <div className="font-mono text-[11px] text-primary uppercase tracking-widest mb-6">
                {step.time}
              </div>
              <div className="font-display font-black text-[22px] leading-tight tracking-[-0.01em] text-foreground mb-4">
                {step.title}
              </div>
              <p className="font-text text-[15px] leading-relaxed text-muted-foreground m-0">
                {step.desc}
              </p>
            </div>
          ))}
      ...
      <section className="px-6 md:px-24 py-24 bg-foreground text-background">
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_1fr] gap-16 lg:gap-24 mb-20">
          <div>
            ...
            <h3 className="font-display font-black text-[clamp(32px,4vw,48px)] leading-[0.92] tracking-[-0.02em] text-primary">
              It fails from a lack of Oversight.
            </h3>
          </div>
          <div className="flex flex-col justify-end">
            <p className="font-text text-[19px] leading-relaxed text-background/70 max-w-[40ch]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-px bg-background/20 border border-background/20">
          {[
            {
            ...
            <div key={i} className="bg-foreground p-8 md:p-12">
              <div className="font-mono text-[13px] text-primary mb-4">0{i+1}.</div>
              <div className="font-display font-black text-[24px] leading-tight tracking-[-0.01em] text-background mb-4">
                {feature.title}
              </div>
              <p className="font-text text-[16px] leading-relaxed text-background/60 m-0">
                {feature.desc}
              </p>
            </div>
          ))}
      ...
      <section className="px-6 md:px-24 py-24 border-b border-foreground">
        <div className="mb-16">
          ...
          <h2 className="font-display font-black text-[clamp(40px,5vw,64px)] leading-tight tracking-[-0.02em] text-foreground max-w-[20ch]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-px bg-foreground border border-foreground">
          {[
            ...
            <div key={i} className="bg-background p-8 md:p-12 group hover:bg-primary/[0.02] transition-colors">
              <div className="font-display font-black text-[28px] leading-tight tracking-[-0.01em] text-foreground mb-4 group-hover:text-primary transition-colors">
                {uc.title}
              </div>
              <p className="font-text text-[16px] leading-relaxed text-muted-foreground m-0 max-w-[40ch]">
                {uc.desc}
              </p>
            </div>
          ))}
      ...
      <section className="px-6 md:px-24 py-24 bg-border text-center flex flex-col items-center">
        <h2 className="font-display font-black text-[clamp(40px,5vw,64px)] leading-tight tracking-[-0.02em] text-foreground mb-6 max-w-[24ch]">
          Ready to empower your enterprise AI with human oversight?
        </h2>
        <p className="font-text text-[18px] leading-relaxed text-muted-foreground mb-10 max-w-[42ch]">
          From initial strategic advisory to on-the-ground implementation across Africa.
        </p>
        <Link
          href="/book"
          className="font-text text-[15px] font-semibold px-8 py-4 bg-primary text-white rounded-full hover:bg-primary/85 transition-colors duration-[120ms]"
        >
