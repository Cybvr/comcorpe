      ...
      <div className="px-6 md:px-24 pt-16 md:pt-24 pb-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-24 mb-24 md:mb-32 items-center">
          <div className="order-2 md:order-1">
            <div className="font-mono text-[13px] text-primary mb-4">01.</div>
            <h2 className="font-display font-black text-[32px] md:text-[48px] leading-tight tracking-h3 text-foreground mb-6">
              Structural Advantage
            </h2>
            <p className="font-text text-[18px] leading-relaxed text-muted-foreground max-w-[40ch]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-24 mb-12 items-center">
          <div className="order-2 md:order-1">
            <div className="font-mono text-[13px] text-primary mb-4">03.</div>
            <h2 className="font-display font-black text-[32px] md:text-[48px] leading-tight tracking-h3 text-foreground mb-6">
              Compounding Value
            </h2>
            <p className="font-text text-[18px] leading-relaxed text-muted-foreground max-w-[40ch]">
