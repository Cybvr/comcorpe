  ...
  return (
    <div className="px-4 py-6 sm:px-6 lg:px-8 lg:py-8 max-w-[920px] mx-auto">
      <div className="mb-8">
        ...
        <h1 className="font-display font-black text-[32px] tracking-[-0.03em] text-foreground leading-none">Client and operator referrals</h1>
      ...
      <section className="border border-border rounded-xl p-6 bg-border/40 mb-6">
