...
export default async function ClientHelpTopicPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <div className="px-8 py-8 max-w-[920px] mx-auto">
      <Link href="/client/dashboard/help" className="font-text text-sm text-ink-60 hover:text-blue transition-colors inline-flex items-center gap-2 mb-8">
        <ArrowLeft size={14} strokeWidth={1.5} />
        Help centre
      </Link>

      <div className="border-b border-ink-10 pb-8 mb-8">
        <p className="font-mono text-xs uppercase tracking-eyebrow text-blue mb-3">Client help</p>
